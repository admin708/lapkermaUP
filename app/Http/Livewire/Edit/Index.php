...
{
    use WithFileUploads;
    public $lockInstansi = [], $lockFakultas = [], $arrayMitra = [], $nama_fakultas = [], $searchProdiMitra = [], $prodiPihak = [], $searchBadanKemitraan;
    ...
    public $nama_pihak = [], $fakultas_pihak = [], $alamat_pihak = [], $koordinat_pihak = [], $negara_pihak = [], $valz, $upBy, $editBy;
    ...
    public function mount($id, $val)
    {
        ...
        if ($val == 'MoA') {
            ...
            $findMeTo2 = MoaPenggiat::where('id_lapkerma', $id)->get();
            ...
            $findMeTo2 = IaPenggiat::where('id_lapkerma', $id)->get();
        ...
        foreach ($findMeTo2 as $key => $value) {
            $this->setInstansi($findMeTo2, $key);
            $this->setPejabat($findMeTo2, $key);
            $this->setPJ($findMeTo2, $key);
                    ...
                    foreach ($this->inputs as $key => $value) {
                        ...
                        $storeInstansi = Instansi::updateOrCreate(
                            ...
                            [
                                ...
                                'badan_kemitraan' => $this->badanKemitraan[$value] ?? null
                            ]
                        );
