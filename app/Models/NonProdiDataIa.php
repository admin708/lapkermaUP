...
class NonProdiDataIa extends Model
{
    protected $table = 'np_data_ia';
    protected $guarded = [];
    ...
    {
        return $this->belongsTo('App\Models\NonProdiDataIaDokumen', 'kerjasama_id');
    }
    ...
    {
        return $this->hasMany('App\Models\NonProdiDataIaBentukKegiatanKerjasama', 'id_ia', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\NonProdiDataIaPenggiat', 'id_lapkerma', 'id');
    }
