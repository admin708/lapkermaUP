...
class MouRequestPenggiat extends Model
{
    protected $table = 'data_mou_request_penggiat';
    protected $guarded = [];
    ...
    {
        return $this->belongsTo(MouRequest::class, 'id_lapkerma');
    }
    ...
    public function getDataMouRequest()
    {
        return $this->hasOne(MouRequest::class, 'id', 'id_lapkerma');
    }
    ...
    public static function countBadanKemitraan($kemitraan = null, $year = null, $fakultas = null, $prodi = null)
    {
        ...
        })->whereHas('getDataMouRequest', function ($query) use ($year, $fakultas, $prodi) {
