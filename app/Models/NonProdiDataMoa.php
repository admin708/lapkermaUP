...
class NonProdiDataMoa extends Model
{
    protected $table = 'np_data_moa';
    protected $guarded = [];
    ...
    {
        return $this->belongsTo('App\Models\NonProdiDataMoaDokumen', 'kerjasama_id');
    }
    ...
    public static function searchBy($tahun=null, $fakultas=null, $noDokumen=null, $judul=null, $status=null, $jenis=null, $namaProdi=null,
                                    $negara=null, $mitra=null, $prodi=null, $tingkat=null)
    {
    ...
    {
        return $this->hasMany('App\Models\NonProdiDataMoaBentukKegiatanKerjasama', 'id_ia', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\NonProdiDataMoaPenggiat', 'id_lapkerma', 'id');
    }
