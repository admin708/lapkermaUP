                        ...
                        <tr>
                            ...
                            <th>
                                <input type="text" class="form-control form-control-sm"
                                    wire:model.lazy="cariNomorDokumen">
                            </th>
                            <th>
                            ...
                            <th>
                                <select class="form-select form-select-sm" wire:model.lazy="cariFakultas"
                                    {{ auth()->user()->role_id == 1 ? '' : (auth()->user()->role_id == 99 ? '' : 'disabled') }}>
                            ...
                            @if (auth()->user()->role_id != 5)
                                <th>
                                    <select class="form-select form-select-sm" wire:model.lazy="cariNamaProdi"
                                        {{ auth()->user()->role_id == 1 ? '' : (auth()->user()->role_id == 4 ? '' : 'disabled') }}>
                                        <option value="">All</option>
                                        ...
                                        <div class="dropdown-menu" style="">
                                            @if ($modeData)
                                                <a class="dropdown-item text-primary" role="button"
                                                    href="{{ route('edit-data', ['Ia', $item->id, 'np']) }}"><i
                                                        class="bx bx-show me-1"></i> View</a>
                                            @else
                                                <a class="dropdown-item text-primary" role="button"
                                                    href="{{ route('edit-data', ['Ia', $item->id]) }}"><i
                                                        class="bx bx-show me-1"></i> View</a>
                                            @endif
                                            <a href="{{ route('laporan', ['IA', $item->id]) }}"
        ...
        <div class="modal-dialog modal-fullscreen" role="document">
            <div class="modal-content">
                <div class="modal-header container">
                    <h4 class="modal-title h4" id="modalFullTitle">
                        {{ $showModalsEdit2 == true ? 'Edit' : '' }} Data
                        MoA Non Prodi</h4>
