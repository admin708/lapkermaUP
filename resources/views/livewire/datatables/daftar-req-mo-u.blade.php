                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item text-primary small" role="button" wire:click="showDetail({{ $item->id }})" data-bs-toggle="modal" data-bs-target="#detailModal">
                                            <i class="bx bx-show me-1"></i> View
                                        </a>
                                        @if (auth()->user()->role_id == 1)
                                            <a class="dropdown-item text-danger small" role="button" wire:click="removeItem({{ $item->id }})">
