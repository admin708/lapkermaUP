        ...
        <div class="col-6">
            ...
            @else
                <button class="btn btn-primary my-3 form-control"
                    wire:click="updates({{ $idEdit }})">Update</button>
            @endif
        </div>
        <div class="col-md-4">
            <div class="card mb-1">
                                ...
                                <li>
                                    ...
                                    @if ($cekDokumen > 1)
                                        @if ($yakinHapus == $item->id)
                                            <i role="button" wire:click="hapusDokumen('{{ $item->id }}')"
                                                class="bx bx-trash text-danger mt-2"
                                                style="float: right; font-size: 15px"> yakin hapus ?</i>
                                        @else
                                            <i role="button" wire:click="yakinHapusDokumen('{{ $item->id }}')"
                                                class="bx bx-trash text-danger mt-2" style="float: right"></i>
                                        @endif
                                    @endif
                                </li>
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div wire:ignore>
                        <div class="{{ $jenis_dokumen_kerjasama == 2 ? 'd-block' : 'd-none' }}">
                            <div>
                                <label class="form-label" for="">Dasar Dokumen Kerjasama <i
                    ...
                    <div>
                        <label class="form-label">Deskripsi <label>
                            ...
                            <textarea wire:model.lazy="deskripsi" class="form-control form-control-sm @error('deskripsi') is-invalid @enderror"
                                        ...
                                        <div class="row col-12">
                                            ...
                                            <div class="btn-group col-12">
                                                <div class="input-group input-group-sm" data-bs-display="static"
                                                    aria-haspopup="true" aria-expanded="true">
                                                    <input placeholder="Ketik Untuk Mencari "
                                                        wire:model.debounce.1s="searchProdiMitra.{{ $value }}"
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start {{ optional($searchProdiMitra)[$value] ? 'show' : '' }}"
                                                    ...
                                                    @foreach ($prodiMitras as $item)
                                                        <li><button
                                                                ...
                                                                class="small dropdown-item
                                                            {{ $item->id == auth()->user()->prodi_id ? 'd-none' : ($item->id == $prodiEx ? 'd-none' : '') }}"
                                        ...
                                        <div class="btn-group col-12">
                                            <div class="input-group input-group-sm" data-bs-display="static"
                                                ...
                                                <input placeholder="Ketik Untuk Mencari "
                                                    ...
                                                    wire:model="nama_fakultas.{{ $key }}" type="text"
                                                    class="form-control form-control-sm">
                                        ...
                                        <div class="row col-12">
                                            ...
                                            <div class="btn-group col-12">
                                                <div class="input-group input-group-sm" data-bs-display="static"
                                                    aria-haspopup="true" aria-expanded="true">
                                                    <input placeholder="Ketik Untuk Mencari "
                                                        wire:model="searchProdiMitra.{{ $value }}"
                                                        type="text" class="form-control form-control-sm">
        ...
        <div class="col-sm-12 col-lg-5">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="col-auto my-2">
                        <div class="col-sm-12">
                            <label>SDGS <i class="small text-danger">*</i> @error('arraySdgs')
                        ...
                        <div class="col-sm-12">
                            <select
                                class="form-select form-select-sm @error('sdgs')
                                is-invalid
                            @enderror"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text"
                                                ...
                                                class="form-control form-control-sm" id="format{{ $key }}"
                                                placeholder="0">
                                        </div>
                                    </div>
                                </div>
