        ...
        <div class="col-md-4">
            <div class="card mb-1">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <input class="form-control form-control-sm" type="file" wire:model="files" id="uploadFiles"
                        multiple accept=".pdf" onchange="checkFileUploadExt(this);" />
                        ...
                        <div>
                            <select style="width: 100%" class="form-select form-select-sm" id="select2-dropdown">
                                ...
                                @forelse ($dasarDokKerjasama as $item)
                                    <option value="{{ $item->id }}">{{ $item->uuid }} | {{ $item->judul }}
                                    </option>
                                @empty
                                    <i>Not Found</i>
                                @endforelse
                    ...
                    <div class="card mb-4" style="display: {{ $value <= $arrayJawaban ? 'block' : 'none' }}">
                        <h5 class="card-header"><i class="bx bx-link me-3"></i>Pihak {{ $value + 1 }}
                            @if ($arrayJawaban != 0 && $arrayJawaban == $value)
                                <button type="button" wire:click="takeArray" class="btn-sm btn text-primary"
                                    style="float: right"><i class="bx bx-layer-plus"></i></button>
                            @endif
                        ...
                        <div class="card-body">
                            <div class="col-auto my-2">
                                ...
                                <select wire:model="status.{{ $value }}"
                                    class="form-select form-select-sm mr-sm-2" {{ $value == 0 ? 'disabled' : '' }}>
                                    <option></option>
                        ...
                        @switch($status[$value]??null)
                            ...
                            @endswitch">
                                <label>Prodi</label>
                                <div wire:ignore.selft>
                                    <select id="multiselect{{ $value }}" class="form-control" multiple
                                        wire:model="arrayProdi.{{ $value }}" style="width: 100%">
                            ...
                            <div class="col-auto my-2">
                                ...
                                <label class="mr-sm-2" for="">Nama</label>
                                <input {{ $value <= $arrayJawaban ? 'required' : '' }}
                                    wire:model.defer="pj_pihak.{{ $value }}" type="text"
                                    class="form-control form-control-sm">
                                <label class="mr-sm-2 mt-2" for="">Jabatan</label>
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-select form-select-sm" aria-hidden="true">
                                            <option></option>
                                            <option value="57ec65bd-e13b-4ebf-911c-a1c9097b8783">Meningkatnya kualitas
                                                lulusan pendidikan tinggi</option>
                                            <option value="e223673c-14ac-4f14-9821-a65c04a8862d">Meningkatnya inovasi
                                                perguruan tinggi dalam rangka meningkatkan mutu pendidikan</option>
                                            <option value="dcb9e13a-28c9-4ddf-803d-6abe69fa787d">Meningkatnya kualitas
                                                dosen pendidikan tinggi</option>
                                            <option value="219cfb2b-d599-4728-a4b8-8c2b2b56869a">Meningkatnya kualitas
                                                kurikulum dan pembelajaran</option>
                                            <option value="9326f685-600f-47a8-a4ea-faf237988f15">Meningkatnya program
                                                studi yang berkualitas</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-auto">
