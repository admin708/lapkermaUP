            ...
            @foreach ($inputs as $key => $value)
                <div class="col-md-12">
                    <div class="card mb-4" style="display: {{ $value <= $arrayJawaban ? 'block' : 'none' }}">
                        <h5 class="card-header text-primary"><i class="bx bx-link me-3"></i>Pihak {{ $value + 1 }} {{ $value == 0 ? "(PARTNER)" : "(UNHAS)"  }}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="submissionModalLabel">Submission Received</h5>
