                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body mt-0">
                            ...
                            @if (optional($arrayMitra)[$key] == 1)
                                ...
                                <select wire:model="fakultas_pihak.{{ $value }}" class="form-select form-select-sm mr-sm-2" {{auth()->user()->role_id != 1 ? 'disabled':''}}>
                                    <option></option>
                                    ...
                                    <div class="
                                        ...
                                        <div class="row col-12">
                                            ...
                                            if (auth()->user()->role_id == 1) {
                                                $prodiMitras = \App\Models\Prodi::whereIn('id_fakultas', $fakultas_pihak)->get();
                                            } else {
