<div>
    ...
    @else
        ...
        <div class="modal fade show" id="backDropModal" data-bs-backdrop="static" tabindex="-1" style="display: block; padding-left: 0px; background-color: rgba(128, 128, 128, 0.418)" aria-modal="true" role="dialog">
            ...
            <form class="modal-content" style="margin-top: 20%">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" wire:click="redirek"></button>
                </div>
                <div class="modal-body">
                <div class="row">
                    <div class="col mb-3">
                    <div class="form-check mt-3">
                        <input wire:model="changeJenis" class="form-check-input" type="radio" value="2">
                        <label class="form-check-label" for="defaultRadio1"> Memorandum of Aggreement (MoA) </label>
                    </div>
                    <div class="form-check mt-3">
                        <input wire:model="changeJenis" class="form-check-input" type="radio" value="3">
                        <label class="form-check-label" for="defaultRadio1"> Implementation Arrangement (IA) </label>
                    </div>
                    </div>
                </div>
                </div>
                <div class="modal-footer">
                <button wire:click="setJenis" wire:loading.attr="disabled" type="button" class="btn btn-primary">Create</button>
                </div>
            </form>
            </div>
        </div>
    ...
    @endif
        <div class="row">
            <div class="col-12">
                ...
                <button class="btn btn-primary my-3 form-control" wire:loading.attr="disabled" wire:click="{{ $jenis_dokumen_kerjasama == 2 ? 'saveMoAPimpinan':'saveIaPimpinan' }}">Simpan</button>
                @else
                <button class="btn btn-primary my-3 form-control" wire:loading.attr="disabled" wire:click="{{ $jenis_dokumen_kerjasama == 2 ? 'saveMoA':'saveIa' }}">Simpan</button>
                @endif
            </div>
            <div class="col-md-4">
                <div class="card mb-1">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="col-auto mb-3">
                        <label class="mr-sm-2" for="">Pilih Jenis Dokumen Kerjasama <i class="small text-danger">*</i>
                        <select wire:model="jenis_dokumen_kerjasama" class="form-select form-select-sm mr-sm-2 @error('jenis_dokumen_kerjasama') is-invalid @enderror">
                            <option></option>
             ...
             <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        <div class="col-auto my-2">
                            <label class="form-label">Jangka Waktu <i class="small">(Tahun)</i> <i class="small text-danger">*</i></label>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body mt-0">
                            <div class="col-auto my-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-lg-7 my-2">
                                        <label class="mr-sm-2">Instansi / Universitas<i class="small text-danger">*</i>
                            ...
                            @if (optional($nama_pihak)[$key] == 'Universitas Hasanuddin' || optional($nama_pihak)[$key] == 'UNHAS' )
                                <label class="mr-sm-2">Unit Kerja <i class="small text-danger">*</i></label>
                                ...
                                <div class="my-2">
                                    <label class="mr-sm-2">Sub Unit Kerja <i class="small text-danger">*</i>
    ...
    <div class="col-sm-12 col-lg-5">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="col-auto my-2">
                    <div class="col-sm-12">
                        <label class="@error('sdgs') text-danger @enderror">SDGS <i class="small text-danger">*</i></label>
                    </div>
                    <div class="col-sm-12">
                ...
                @forelse ($arrayBentukKegiatan as $key => $item)
                    <div class="card my-1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-auto">
                                <div class="col-sm-12">
                                    <label class="@error('arraySasaran.'.$key) text-danger @enderror"s>Sasaran <i class="small text-danger">*</i></label>
                            ...
                            <div class="col-auto">
                                <div class="col-sm-12">
                                    <label class="@error('arrayKinerja.'.$key) text-danger @enderror">Indikator Kinerja <i class="small text-danger">*</i></label>
                                </div>
                                <div class="col-sm-12">
